"""
Django settings for gametalk project.
...
SECRET_KEY = os.environ.get("SECRET_KEY", "7l-%465azu#j453egh2+*yxpmb7#nonf*s_p9o7bwkxa8qjdno")
...
WSGI_APPLICATION = 'gametalk.wsgi.application'
